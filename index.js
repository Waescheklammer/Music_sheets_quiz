...
function randomizeChoiceButtons(buttons, randomDec){
	...
	let choices = [];
		choices[0] = solution[solutionIndex] +"_";
		choices[1] = textSelection[0];
		choices[2] = textSelection[1];
		choices[3] = textSelection[2];
...
function renderNotes(type){
	...
	let noteType;
	if(type==1){noteType="bass"}
	if(type==2){noteType="treble"}
	var clef = noteType;
	console.log(clef);
